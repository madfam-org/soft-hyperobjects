# Printed Hinge Collar

A **Yantra4D-bridged notion** for the additive-manufacturing frontier of trims — a 3D-printed TPU collar band with a living-hinge fold line that stands up or folds down and holds its crease — no interfacing, no topstitched roll line.
...
[`tpu-hinge-collar`](https://app.yantra4d.com) solid, referenced through `notion.hardware_ref`.
...
Linked to the Yantra4D `tpu-hinge-collar` cartridge. The bridge is **dimensional**: the guide's
